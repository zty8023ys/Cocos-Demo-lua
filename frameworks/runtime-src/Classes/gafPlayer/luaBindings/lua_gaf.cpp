...
static int lua_gaf_GAFObject_setAnimationFinishedPlayDelegate(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFObject* cobj = nullptr;
    bool ok  = true;
  ...
  //      do {
        ...
        int handle = toluafix_ref_function(tolua_S, 2, 0);
        cobj->setAnimationFinishedPlayDelegate([&,handle](gaf::GAFObject* obj) {
